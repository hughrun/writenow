...
`   ${chalk.white('writenow')} ${chalk.cyan('config')}
    ...
    ${chalk.green('Process Command')} - this is the command you use to process your markdown files into posts 
    and pages. e.g. ${chalk.blue('eleventy --quiet')} or ${chalk.blue('jekyll build')}
`
    )  
}
...
function process() {
  return console.log(
    `   ${chalk.white('writenow')} ${chalk.cyan('process')}
